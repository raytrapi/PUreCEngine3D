...
void renderable::Cube::crearCubo(float l, float r, float g, float b, float a) {
   ...
   numCoordenadas = numeroVertices * 15; //3+3+4+2+3 (3 coordenadas + 3 normales + 4 color + 2 uv + 3 escala
   ...
   //Frente azul
   for (int i = 0; i < 6; i++) {
      colores[iColor++] = 0.0f; colores[iColor++] = 0.0f; colores[iColor++] = 1.0f; colores[iColor++] = 1.0f;
   }
   for (int i = 0; i < 6; i++) {
